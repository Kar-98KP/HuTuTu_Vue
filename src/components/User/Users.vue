<template>
  <div>
    ...
    <el-dialog
      title="分配角色"
      :visible.sync="setRoledDialogVisible"
      width="50%"
      @close="setRoledDialogClosed"
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRoledDialogVisible = false">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    async setRole(userInfo) {
      ...
      this.setRoledDialogVisible = true
    },
    // 点击分配角色
    async saveRoleInfo() {
      ...
      this.getUserList()
      this.setRoledDialogVisible = false
    },
    //重置选中项
    setRoledDialogClosed() {
      this.selectedRoleId = ''
      this.userInfo = {}
    },
  },
